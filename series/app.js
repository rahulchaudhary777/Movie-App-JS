...
function api(page){
    axios.get(`https://api.themoviedb.org/3/discover/tv?api_key=20ed534a806cf31b3dbb32a0c57301a4&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=${page}`)
    .then((responce)=>{
